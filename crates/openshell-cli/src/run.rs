...
mod tests {
    ...
    fn configuration_activation_json_exposes_repair_diagnostic_and_accepted_generation() {
        ...
        status.conditions.push(SandboxCondition {
            ...
            last_transition_time: "2026-09-05T11:00:00Z".to_string(),
        });
        status.endpoint_statuses.push(EndpointStatus {
            endpoint_id: "endpoint:accepted".to_string(),
        ...
        assert_eq!(
            json["conditions"][0]["last_transition_time"],
            "2026-09-05T11:00:00Z"
        );
        assert_eq!(
            json["endpoint_statuses"][0]["last_result"],
            "TransportFailed"
        );
        assert_eq!(
